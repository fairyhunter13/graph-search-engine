...
description: "The two-engine measurement drives `coderag search` twenty times, and every invocation builds its own CUDA session beside the daemon's. The card is 16303 MiB, the daemon holds 7660 MiB and one CLI search adds 3114 MiB, so a third consumer exhausts it."
