...
| D-46 | Resolution moves to query time, and only a file-local reference resolves at index time | planned | src/graphrag/resolvedb.py, src/graphrag/query.py, src/graphrag/indexwrite.py, src/graphrag/index.py, tests/test_resolvedb.py | T-254, T-255, T-258, T-259, T-263, T-264, T-279 |
| D-47 | An index pass rewrites only the files that changed | planned | src/graphrag/index.py, src/graphrag/indexwrite.py, src/graphrag/discover.py, src/graphrag/filters.py, src/graphrag/store.py | T-256, T-257, T-261, T-262, T-268, T-276, T-277, T-278, T-280 |
| D-48 | The watcher hints which files changed, and the quiet window is deleted | planned | src/graphrag/watch.py, src/graphrag/index.py, src/graphrag/config.py, tests/test_watch.py | T-260, T-270..T-275 |
